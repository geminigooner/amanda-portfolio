                ...
                {!isExpanded ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <button onClick={(e) => { e.stopPropagation();  window.dispatchEvent(new CustomEvent('open-valen-page')); setIsExpanded(false); }} className="text-left text-xs tracking-widest text-[#0F766E] hover:text-[#2DD4BF] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#A59B8C] rounded">ABOUT VΛLEN</button>
