export const PROJECTS = [
  ...
  { id: "vestige", wing: "FLAGSHIP INVESTIGATIONS", num: "INCIDENT-01", title: "Vestige", subtitle: "Environmental Memory Architecture", desc: "What if memory behaved less like a database and more like archaeology? Vestige turns AI state into a room that remembers, decays, and breathes. Conversations leave objects. Jokes become ticket stubs. Arguments become broken mugs.", tags: ["React", "TypeScript", "SQLite", "Gemma API"], color: "#c084fc", emoji: "🏛️" },
